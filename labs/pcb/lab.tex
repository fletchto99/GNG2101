...
\newcommand{\assignmentType}{PCB Lab}
\newcommand{\assignmentNumber}{}
\newcommand{\dueDate}{Jan 18, 2018}
...
The substrate FR4 gives the ridged structure.

\section*{Question 3}

Copper is the conductive material.

\section*{Question 4}

This is done by layering multiple substrates together and then having the copper traces be conductive. Drilled holes make the connections through the board.

\section*{Question 5}

The silkscreen indicates the position of any important components.
